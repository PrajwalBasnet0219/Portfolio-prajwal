...
function useIsMobile() {
    _s();
    const [isMobile, setIsMobile] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](("TURBOPACK compile-time truthy", 1) ? window.innerWidth < MOBILE_BREAKPOINT : "TURBOPACK unreachable");
...
_s(useIsMobile, "dB+NpFHGkrMGfSLa+Zo0trrUDTw=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: Array.from({
                    length: isMobile ? 4 : 12
                        ...
                        className: "particle",
                        style: {
                            left: "".concat(i * (isMobile ? 22 : 8.3) % 100, "%"),
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const isMobile = "object" !== "undefined" && (window.innerWidth < 768 || window.matchMedia("(pointer: coarse)").matches || window.matchMedia("(prefers-reduced-motion: reduce)").matches);
            let lenis = null;
            const ticker = {
                "Home.useEffect.ticker": (time)=>{
                    if (lenis) lenis.raf(time * 1000);
                }
            }["Home.useEffect.ticker"];
            if (!isMobile) {
...
//# sourceMappingURL=_47a2ced6._.js.map