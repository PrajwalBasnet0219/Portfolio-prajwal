...
function FisheyeCursor({ className, children, strength = 110, radius = 380, mapScale = 5, damping = 0.16, ring = true, ringColor = "#ffffff" }) {
    ...
    if ("undefined" !== "undefined" && (window.matchMedia("(pointer: coarse)").matches || window.matchMedia("(max-width: 768px)").matches || window.matchMedia("(prefers-reduced-motion: reduce)").matches)) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if ("undefined" !== "undefined" && (window.matchMedia("(pointer: coarse)").matches || window.innerWidth < 768 || window.matchMedia("(prefers-reduced-motion: reduce)").matches)) //TURBOPACK unreachable
        ;
...
//# sourceMappingURL=_99cc3615._.js.map